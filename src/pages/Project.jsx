...
import { doc, getDoc, collection, onSnapshot, query, orderBy, getDocs, where, documentId } from "firebase/firestore";
    ...
    <div className={styles.taskGrid}>
        ...
        <div key={t.id} className={styles.taskCard}>
            <div className={styles.taskHead}>
                ...
                <EditTasksModal projectId={projectId} task={t} members={project.members || []} />
            </div>
            ...
            {t.deadline?.toDate && (
                <span className={styles.meta}>
                <b>Deadline:</b> {t.deadline.toDate().toLocaleDateString()}
                </span>
            )}
